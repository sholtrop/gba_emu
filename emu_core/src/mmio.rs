...
pub(crate) mod background {
    ...
    impl MmioRegister for Bg2RefPoint {
...
mod test {
    ...
    #[test]
    fn test_tmute() {
        let x = 0xFF_00_u16.to_le_bytes();
        unsafe {
            let y = std::mem::transmute::<_, DisplayControlRegister>(x);
            println!("{:#?}", y);
            assert!(false)
        }
    }
